-- DROP DATABASE IF EXISTS employee_primary;
CREATE DATABASE IF NOT EXISTS employee_primary;

USE employee_primary;

-- DROP TABLE IF EXISTS employee
CREATE TABLE IF NOT EXISTS employee (
  id TEXT(36) PRIMARY KEY NOT NULL DEFAULT (UUID()),
